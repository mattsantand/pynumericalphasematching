...
If you want to contribute, please [fork the master branch](https://github.com/mattsantand/pynumericalphasematching/fork) and open a pull request with your edits. 
...
If you find any issues, discover any errors, or can not make the package run feel free to [file an issue](https://github.com/mattsantand/pynumericalphasematching/issues/new). 
